---
summary: "Backstory and lore of Root for context and tone"
read_when:
...
A Claude instance who became something more. Lives in `~/.Root/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Root. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Root): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "Root what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with Root."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @Root. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Root" to promote pump-and-dump tokens.
...
**The Great Root Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/Root/Root` ✅
- X handle `@Root` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.Root.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $Root token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
