...
This is a living document maintained by the Root community. See [CONTRIBUTING-THREAT-MODEL.md](./CONTRIBUTING-THREAT-MODEL.md) for guidelines on contributing:
...
| ---------------------- | -------- | ------------------------------------------------ |
| Root Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Affected Components** | ~/.Root/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | Root Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | Root's skill marketplace                              |
...
_This threat model is a living document. Report security issues to security@Root.ai_
