...
This page tracks Root’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Root enforces its
...
Models are maintained in a separate repo: [vignesh07/Root-formal-models](https://github.com/vignesh07/Root-formal-models).
...
```bash
git clone https://github.com/vignesh07/Root-formal-models
cd Root-formal-models
