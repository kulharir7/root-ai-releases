...
Goal: Root Gateway running on an exe.dev VM, reachable from your laptop via: `https://<vm-name>.exe.xyz`
...
Tip: keep this VM **stateful**. Root stores state under `~/.Root/` and `~/.Root/workspace/`.
