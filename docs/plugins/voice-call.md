...
read_when:
  - You want to place an outbound voice call from Root
...
- Use `Root voicecall ...` or the `voice_call` tool
...
```bash
Root voicecall call --to "+15555550123" --message "Hello from Root"
Root voicecall continue --call-id <id> --message "Any questions?"
Root voicecall speak --call-id <id> --message "One moment"
