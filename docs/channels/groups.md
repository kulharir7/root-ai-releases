...
Root treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.
...
Translation: allowlisted senders can trigger Root by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@Root", "Root", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
