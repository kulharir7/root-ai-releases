...
Tlon is a decentralized messenger built on Urbit. Root connects to your Urbit ship and can
...
By default, Root blocks private/internal hostnames and IP ranges for this plugin (SSRF hardening).
...
- Thread replies: if the inbound message is in a thread, Root replies in-thread.
