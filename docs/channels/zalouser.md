...
- `Root pairing list zalouser`
- `Root pairing approve zalouser <code>`
...
- On startup, Root resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
