...
That's it. Root now routes through LiteLLM.
...
Root keeps requesting `claude-opus-4-6` — LiteLLM handles the routing.
...
- Root connects via the OpenAI-compatible `/v1/chat/completions` endpoint
- All Root features work through LiteLLM — no limitations
