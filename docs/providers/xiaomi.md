---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Root"
read_when:
  - You want Xiaomi MiMo models in Root
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Root uses
