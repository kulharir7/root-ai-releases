---
summary: "Use Qianfan's unified API to access many models in Root"
read_when:
...
3. Root installed on your system
...
4. Copy the API key for use with Root

## CLI setup

```bash
Korvus onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Root Configuration](/gateway/configuration)
