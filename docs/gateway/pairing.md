...
Pairing state is stored under the Gateway state directory (default `~/.Root`):

- `~/.Root/nodes/paired.json`
- `~/.Root/nodes/pending.json`

If you override `Root_STATE_DIR`, the `nodes/` folder moves with it.
