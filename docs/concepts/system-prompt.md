---
summary: "What the Root system prompt contains and how it is assembled"
read_when:
...
- **Root Self-Update**: how to run `config.apply` and `update.run`.
- **Workspace**: working directory (`agents.defaults.workspace`).
- **Documentation**: local path to Root docs (repo or npm package) and when to read them.
...
- `minimal`: used for sub-agents; omits **Skills**, **Memory Recall**, **Root
...
When eligible skills exist, Root injects a compact **available skills list**
