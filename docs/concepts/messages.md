...
This page ties together how Root handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Root keeps a
...
Root separates the **prompt body** from the **command body**:
