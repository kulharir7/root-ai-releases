...
Root treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.Root/settings/voicewake.json`

Shape:

```json
{ "triggers": ["Root", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
