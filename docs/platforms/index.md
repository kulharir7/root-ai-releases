...
Root core is written in TypeScript. **Node is the recommended runtime**.
...
- macOS: LaunchAgent (`bot.molt.gateway` or `bot.molt.<profile>`; legacy `com.Root.*`)
- Linux/WSL2: systemd user service (`Root-gateway[-<profile>].service`)
