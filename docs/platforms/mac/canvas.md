...
- `~/Library/Application Support/Root/canvas/<session>/...`

The Canvas panel serves those files via a **custom URL scheme**:

- `Root-canvas://<session>/<path>`

Examples:

- `Root-canvas://main/` → `<canvasRoot>/main/index.html`
- `Root-canvas://main/assets/app.css` → `<canvasRoot>/main/assets/app.css`
- `Root-canvas://main/widgets/todo/` → `<canvasRoot>/main/widgets/todo/index.html`
...
```
http://<gateway-host>:18789/__Root__/a2ui/
```
...
```js
window.location.href = "Root://agent?message=Review%20this%20design";
```
