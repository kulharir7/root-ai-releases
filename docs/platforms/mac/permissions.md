...
- Same path: run the app from a fixed location (for Korvus, `dist/Root.app`).
...
Workaround: move files into the Root workspace (`~/.Root/workspace`) if you want to avoid per-folder grants.
