...
This enables Tailscale SSH, so you can connect via `ssh Root` from any device on your tailnet — no public IP needed.
...
- `~/.Root/` — config, credentials, session data
- `~/.Root/workspace/` — workspace (SOUL.md, memory, artifacts)
