...
This guide summarizes a sane workflow for working on the pi integration in Root.
...
State lives under the Root state directory. Default is `~/.Root`. If `Root_STATE_DIR` is set, use that directory instead.

To reset everything:

- `Root.json` for config
...
- [https://docs.Root.ai/testing](https://docs.Root.ai/testing)
- [https://docs.Root.ai/start/getting-started](https://docs.Root.ai/start/getting-started)
