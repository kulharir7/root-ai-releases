...
Details:
  Source: Root-bundled
  Path: /path/to/Root/hooks/bundled/session-memory/HOOK.md
  Handler: /path/to/Root/hooks/bundled/session-memory/handler.ts
  Homepage: https://docs.Root.ai/automation/hooks#session-memory
  Events: command:new
...
- Copies the hook pack into `~/.Root/hooks/<id>`
