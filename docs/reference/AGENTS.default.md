...
# AGENTS.md — Root Personal Assistant (default)
...
```bash
cp docs/reference/templates/AGENTS.md ~/.Root/workspace/AGENTS.md
cp docs/reference/templates/SOUL.md ~/.Root/workspace/SOUL.md
cp docs/reference/templates/TOOLS.md ~/.Root/workspace/TOOLS.md
```

3. Optional: if you want the personal assistant skill roster, replace AGENTS.md with this file:

```bash
cp docs/reference/AGENTS.default.md ~/.Root/workspace/AGENTS.md
```
...
- macOS app manages permissions (screen recording, notifications, microphone) and exposes the `Root` CLI via its bundled binary.
...
- Prefer the `Root` CLI for scripting; mac app handles permissions.
